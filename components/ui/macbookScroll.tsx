...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="sm:h-[72rem] flex flex-col items-center py-0  justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-50 sm:scale-75 xl:scale-1"
    >
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] z-0 absolute inset-0 bg-[#010101] rounded-2xl p-2 border-border border-2 overflow-hidden shadow-2xl shadow-muted-foreground/10"
      >
        <div className="absolute  bg-[#272729] rounded-lg " />
        <Image
          src={src as string}
          alt="Thunder preview software"
          fill
...
export const Trackpad = () => {
  return (
    <div
      className="w-[25%] mx-auto h-32  rounded-xl my-1"
      style={{
